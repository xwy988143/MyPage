...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="__PUBLIC__/Web/css/normalize.css">
        <link rel="stylesheet" href="__PUBLIC__/Web/css/font-awesome.css">
        <link rel="stylesheet" href="__PUBLIC__/Web/css/bootstrap.min.css">
        <link rel="stylesheet" href="__PUBLIC__/Web/css/templatemo-style.css">
        <script src="__PUBLIC__/Web/js/vendor/modernizr-2.6.2.min.js"></script>
    </head>
    <body>
        <!--[if lt IE 7]>
                ...
                <div class="col-md-9 col-sm-12 content-holder">
                    ...
                    <div id="menu-container">
                        ...
                        <div class="logo-holder logo-top-margin">
                            <a href="#" class="site-brand"><img src="__PUBLIC__/Web/images/logo.png" alt=""></a>
                        </div>
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="box-content profile">
                                        ...
                                        <div class="profile-thumb">
                                            <img src="__PUBLIC__/Web/images/1.jpg" alt="">
                                        </div>
                                        <div class="profile-content">
                                            <h5 class="profile-name">{$data.name}</h5>
                                            <span class="profile-role">{$data.position}</span>
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <div class="box-content">
                                        ...
                                        <div class="project-item">
                                            <img src="__PUBLIC__/Web/images/7.jpg" alt="">
                        ...
                        <div id="menu-3" class="content gallery-section">
                            <div class="box-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="project-item">
                                            <img src="__PUBLIC__/Web/images/2.jpg" alt="">
                                            <div class="project-hover">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="project-item">
                                            <img src="__PUBLIC__/Web/images/3.jpg" alt="">
                                            <div class="project-hover">
                                                <h4>Great Nature Capture</h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="project-item">
                                            <img src="__PUBLIC__/Web/images/4.jpg" alt="">
                                            <div class="project-hover">
                                                <h4>Another Image Caption</h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="project-item">
                                            <img src="__PUBLIC__/Web/images/5.jpg" alt="">
                                            <div class="project-hover">
                                                <h4>Great Nature Capture</h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="project-item">
                                            <img src="__PUBLIC__/Web/images/6.jpg" alt="">
                                            <div class="project-hover">
                                                <h4>Another Image Caption</h4>
                                            </div>
                                        </div>
        ...
        <script src="__PUBLIC__/Web/js/vendor/jquery-1.10.2.min.js"></script>
        <script src="__PUBLIC__/Web/js/plugins.js"></script>
