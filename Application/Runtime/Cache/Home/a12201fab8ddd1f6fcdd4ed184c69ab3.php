...
<!--                </ol>-->
            ...
            <section class="content">
                <?php $array['title'] = '文章列表'; $array['thead'] = '标题,分类,状态,概要,发布时间,操作'; $array['dataUrl'] = U('Home/Admin/getArticle'); $array['editUrl'] = U('Home/Admin/editArticle'); $array['delUrl'] = U('Home/Admin/delArticle'); $array['buttons'] = 'del'; ?>
<?php echo W('table/index', array($array));?>
...
<script>
  $(function(){
    var columns = [
      ...
      { "data": "time" },
      { "data": function(a){
        return '<div class="btn-group"><a href="<?php echo ($array['editUrl']); ?>&id='+a.id+'" class="btn btn-default btn-xs"><i class="fa fa-edit"></i></a><a href="<?php echo ($array['delUrl']); ?>&id='+a.id+'"  class="btn btn-default btn-xs"><i class="fa fa-trash-o"></i></a></div>';
      } }
    ]
    datatable('#lists', "<?php echo ($array['dataUrl']); ?>", columns);
  })
</script>
            </section>
        </div>
