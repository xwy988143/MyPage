        ...
        <div class="box box-success">
            ...
            <div class="box-body no-padding">
                <div class="row">
                    <div class="col-md-11">
                        <div class="pad">
                            <?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="media">
                                <a class="media-left" href="#">
                                    <img src="<?php echo ($vo['picUrl']); ?>" alt="新闻图片">
                                </a>
