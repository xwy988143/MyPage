...
<!--                </ol>-->
    ...
    <!-- form start -->
    <form class="form-horizontal article" action="<?php echo U('Admin/doEdit');?>" method="post">
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-3">
                    <select name="type" class="form-control">
                        <?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">排序呢</label>
                <div class="col-xs-5">
                    <div class="input-group">
                        <input type="text" name="sort" value="<?php echo ($data["sort"]); ?>"  class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-3">
                    <div class="input-group">
                        <input type="radio"<?php if($data['status'] == 1): ?>checked="true"<?php endif; ?>  name="status" value="1"/>已审核
                        <input type="radio"<?php if($data['status'] == 0): ?>checked="true"<?php endif; ?>  name="status" value="0"/>未审核
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    <textarea class="form-control" rows="9" name="content"><?php echo ($data["content"]); ?></textarea>
...
//                var url="<?php echo U('Admin/doEdit');?>";
//
...
//                            content:"修改成功"
//                        }).showModal();
//                        window.location.href= "<?php echo U('Admin/article');?>";
//                    }else{
//                        alert('操作失败');
//                    }
//                },'json')
