...
<script>
  $(function(){
    var columns = [
      ...
      { "data": "time" },
      { "data": function(a){
        return '<div class="btn-group"><a href="{$array['editUrl']}&id='+a.id+'" class="btn btn-default btn-xs"><i class="fa fa-edit"></i></a><a href="javascript:;" onclick="" d-id="'+ a.id+'"  class="btn btn-default btn-xs"><i class="fa fa-trash-o"></i></a></div>';
      } }
    ]
